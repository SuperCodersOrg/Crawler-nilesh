...
int main() {
    ...
    <meta name="twitter:description" content="We invest in India’s talent potential and integrate them into the world’s best tech companies.">
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" as="style" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    <link rel="stylesheet" as="style" href="https://fonts.googleapis.com/css2?family=Raleway:wght@400;500;600;700;800;900&amp;display=swap" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    <link rel="stylesheet" as="style" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
    </noscript>

    <link rel="stylesheet" href="/css/index.css">
    <link rel="stylesheet" as="style" href="/css/supercoder.css" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="stylesheet" as="style" href="/css/home.css" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
...
<header class="at-top" style="background-color: transparent;">
  <div class="part left">
  ...
  <nav class="part right">
    <ul class="items">
      ...
      <li class="expandable-item collapsed" hidden="">
        ...
        <div class="gradient-bg">
            <section class="home-hero">
                <div class="column">
                    ...
                    <div class="user-images" id="hero-user-images"><img src="/images/testimonials/sameer-garg.jpeg" alt="Sameer Garg"><img src="/images/testimonials/niyati-sharma.jpeg" alt="Niyati Sharma"><img src="/images/testimonials/ashwani.jpeg" alt="Ashwani"><img src="/images/testimonials/gurjinder-singh.jpeg" alt="Gurjinder Singh"><img src="/images/testimonials/raghav-kahol.jpeg" alt="Raghav Kahol"><img src="/images/testimonials/gaurav-malik.jpeg" alt="Gaurav Malik"></div>
                    <br class="for-mobile-only">
                    <a href="#our-mission" class="button btn">
                        We are on a mission
...
<section class="container logos-section">
  ...
  <ul id="logos-area"><li><img src="/images/logos/google.svg" alt="Google" title="Google" loading="lazy"></li><li><img src="/images/logos/amazon.svg" alt="Amazon" title="Amazon" loading="lazy"></li><li><img src="/images/logos/digital-ocean.svg" alt="Digital Ocean" title="Digital Ocean" loading="lazy"></li><li><img src="/images/logos/adobe.svg" alt="Adobe" title="Adobe" loading="lazy"></li><li><img src="/images/logos/palo-alto.svg" alt="PaloAlto" title="PaloAlto" loading="lazy"></li><li><img src="/images/logos/samsung.svg" alt="Samsung" title="Samsung" loading="lazy"></li><li><img src="/images/logos/gojek.svg" alt="Gojek" title="Gojek" loading="lazy"></li><li><img src="/images/logos/mc-afee.png" alt="McAfee" title="McAfee" loading="lazy"></li><li class="small"><img src="/images/logos/grab.svg" alt="Grab" title="Grab" loading="lazy"></li><li><img src="/images/logos/flipkart.svg" alt="Flipkart" title="Flipkart" loading="lazy"></li><li><img src="/images/logos/swiggy.svg" alt="Swiggy" title="Swiggy" loading="lazy"></li><li class="small-2"><img src="/images/logos/amazon-web-services.svg" alt="Amazon Web Services" title="Amazon Web Services" loading="lazy"></li><li><img src="/images/logos/zomato.svg" alt="Zomato" title="Zomato" loading="lazy"></li><li class="small"><img src="/images/logos/oyo.png" alt="OYO" title="OYO" loading="lazy"></li><li><img src="/images/logos/expedia.svg" alt="Expedia" title="Expedia" loading="lazy"></li><li><img src="/images/logos/paytm.svg" alt="Paytm" title="Paytm" loading="lazy"></li><li><img src="/images/logos/far-mart.png" alt="FarMart" title="FarMart" loading="lazy"></li><li><img src="/images/logos/make-my-trip.svg" alt="MakeMyTrip" title="MakeMyTrip" loading="lazy"></li><li><img src="/images/logos/tata-1mg.svg" alt="Tata 1mg" title="Tata 1mg" loading="lazy"></li><li><img src="/images/logos/scotiabank.png" alt="Scotiabank" title="Scotiabank" loading="lazy"></li></ul>
</section>
<script>
...
<div id="carouselExampleIndicators" class="carousel slide pointer-event" data-ride="carousel">
  ...
  <div class="carousel-inner"><div class="carousel-item active">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Dr.-Rakesh-Kumar.png" alt="Dr. Rakesh Kumar">
          </div>
          <div>
            <p class="user-name">Dr. Rakesh Kumar</p>
            <p class="user-desigination">Chairperson - DCSA, Kurukshetra University</p>
            <p class="user-review">We've had a longstanding partnership with CodeQuotient since their early days at Kurukshetra University. It's been rewarding to see our students grow into skilled SuperCoders through their hands-on training. We’re confident CodeQuotient will continue to produce exceptional tech talent and look forward to many more successful collaborations.</p>
          </div>
        </div>
      </div><div class="carousel-item">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Dr. Divya Bartaria.png" alt="Dr. Divya Bartaria">
          </div>
          <div>
            <p class="user-name">Dr. Divya Bartaria</p>
            <p class="user-desigination">Head of Corporate Relations, United Group of Institutions</p>
            <p class="user-review">CodeQuotient has been a trusted partner of our institutions, providing quality training and placement opportunities to our students. We're proud to see many of our students, after completing CodeQuotient's programs, emerge as skilled SuperCoders and secure positions at leading tech companies. We look forward to many more successful collaborations and the continued development of our students.</p>
          </div>
        </div>
      </div><div class="carousel-item">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Prof. Dinesh Kumar Madan.png" alt="Prof. Dinesh Kumar Madan">
          </div>
          <div>
            <p class="user-name">Prof. Dinesh Kumar Madan</p>
            <p class="user-desigination">Chairperson - Department of ICT, Chaudhary Bansi Lal University</p>
            <p class="user-review">We are extremely impressed by the passion and commitment of CodeQuotient and its founder, Arun Goyat, who are deeply dedicated to addressing the talent development challenges. Their drive led to the launch of India’s first Industry-Integrated BCA program in partnership with CBLU, Bhiwani, specifically aimed at uncovering talent from Haryana's underserved areas often overlooked by many EdTech companies.</p>
          </div>
        </div>
      </div><div class="carousel-item">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Mr. Sukhmeet Singh.png" alt="Mr. Sukhmeet Singh">
          </div>
          <div>
            <p class="user-name">Mr. Sukhmeet Singh</p>
            <p class="user-desigination">Director - Chitkara University Advance Technology Network</p>
            <p class="user-review">CodeQuotient’s Learning and Assessment Platform has greatly improved student outcomes at Chitkara University, Punjab. Its self-paced modules, practice exercises, and proctored auto-graded assessments focus on practical skills and problem-solving to produce industry-ready graduates. Instant feedback and detailed OBE-aligned reports streamline evaluation, allowing faculty to prioritize teaching and mentoring. We look forward to strengthening this partnership.</p>
          </div>
        </div>
      </div><div class="carousel-item">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Dr. Naveen Kumar.png" alt="Dr. Naveen Kumar">
          </div>
          <div>
            <p class="user-name">Dr. Naveen Kumar</p>
            <p class="user-desigination">Training &amp; Placement Officer - Himachal Pradesh University</p>
            <p class="user-review">CodeQuotient has been an invaluable partner in training and placing our students. Their platform complements our curriculum with rich learning resources and regular mentor guidance, enhancing problem-solving skills and student confidence. Their commitment to student success has led to numerous successful placements.</p>
          </div>
        </div>
      </div><div class="carousel-item">
        <div class="user-testimonials">
          <div class="user-image-container">
            <img class="user-image" src="/images/universities-testimonials/Nishant Tripathi.png" alt="Nishant Tripathi">
          </div>
          <div>
            <p class="user-name">Nishant Tripathi</p>
            <p class="user-desigination">Chairman (BG) - SSIPMT, Raipur</p>
            <p class="user-review">CodeQuotient has been an exceptional partner in enhancing our students' learning through practical training and the SuperCoders Program. Their support builds confidence and industry-relevant skills, contributing to consistently strong placements across batches. They add significant value to our educational ecosystem, and we appreciate their ongoing commitment to student success.</p>
          </div>
        </div>
      </div></div>
        ...
        <section class="bg-image-footer">
            ...
            <div class="testimonials-holder">
                <div id="testimonials" class="container-fluid">
                    ...
                    <div id="testimonial-cards" class="cards"><card class="card">
    <div class="image-container" style="background-image: url('/images/testimonials/pavneet-kaur.jpeg')">
      <div class="image" style="background-image: url('/images/testimonials/pavneet-kaur.jpeg')"></div>
    </div>
    <div class="content">
      <div class="review">CodeQuotient was the launchpad that propelled my software engineering career to new heights. Their unique approach, where I learned software engineering by building real-world software projects such as a full-stack E-commerce platform and Coding Mania for competitive programming, provided me with invaluable skills. This personalized journey has been the cornerstone of my career growth.</div>
      <div class="name">Pavneet Kaur</div>
      <div class="company"><img src="/images/logos/google.svg" alt="Google" height="28"></div>
    </div>
  </card><card class="card">
    <div class="image-container" style="background-image: url('/images/testimonials/sameer-garg.jpeg')">
      <div class="image" style="background-image: url('/images/testimonials/sameer-garg.jpeg')"></div>
    </div>
    <div class="content">
      <div class="review">CodeQuotient has had a great impact on my career in the tech industry. One Best thing I liked about CodeQuotient is that they take time to teach the logic behind the code.Currently, I'm working as a Senior Staff Engineer at Palo Alto networks, and a lot of the credit goes to Arun sir and all other mentors in CodeQuotient.</div>
      <div class="name">Sameer Garg</div>
      <div class="company"><img src="/images/logos/palo-alto.svg" alt="Palo Alto Networks" height="20"></div>
    </div>
  </card><card class="card">
    <div class="image-container" style="background-image: url('/images/testimonials/balwinder-singh.jpeg')">
      <div class="image" style="background-image: url('/images/testimonials/balwinder-singh.jpeg')"></div>
    </div>
    <div class="content">
      <div class="review">CodeQuotient's blend of practical and theoretical learning transformed my approach to programming. The hands-on projects and mentor support were pivotal in enhancing my coding skills. This program isn't just about landing a job; it's about becoming a well-rounded software engineer.</div>
      <div class="name">Balwinder Singh</div>
      <div class="company"><img src="/images/logos/adobe.svg" alt="Adobe Systems" height="20"></div>
    </div>
  </card></div>
            ...
            <section class="all-sections-container no-bg">
                ...
                <section class="in-the-news-section container-fluid mt-md-5 mt-0 mb-0 mb-md-5" id="about" style="max-width: calc(1604px / var(--base-font));">
                    ...
                    <div class="d-flex mt-4" id="newsSection">
                        ...
                        <div class="d-flex overflow-hidden MS-content"><style>
  #about #newsSection .img__placeholder {
    display: flex;
    justify-content: center;
    min-height: 164px;
...
</style><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-officelife-workplaceculture-activity-7451955344777351168-Rz2Z?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/wekend_vibes.png" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Weekend Vibes at CodeQuotient">
          Weekend Vibes at CodeQuotient
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_supercoders-codequotient-techcareers-activity-7449395227066335232-qAgL?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/placement_drive_at_ssipmt.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="SuperCoders Drive at SSIPMT, Raipur">
          SuperCoders Drive at SSIPMT, Raipur
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_republicday-teamcelebration-workculture-activity-7421823319517315072-rPGN?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/republic_day-2026.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Republic Day Celebrations at CodeQuotient">
          Republic Day Celebrations at CodeQuotient
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_campusrecruitment-campusdrive-codequotient-activity-7433115300151300096-v44-?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/placement_drive_at_chitkara.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Placement Drive at Chitkara University">
          Placement Drive at Chitkara University
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_holicelebration-codequotient-festivalofcolors-activity-7435260411245113344-OY_X?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/holi_2026.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Holi Celebration at CodeQuotient">
          Holi Celebration at CodeQuotient
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-campushiring-placementdrive-activity-7438092534385377282-fkGc?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/placement_drive_at_uiet.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Placement Drive at UIET, Kurukshetra University">
          Placement Drive at UIET, Kurukshetra University
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-supercoders-campusdrive-activity-7444322976847552512-WaQa?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/supercoders_drive_at_guru_nanak_college.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="SuperCoders Drive at Guru Nanak Engineering College, Ludhiana">
          SuperCoders Drive at Guru Nanak Engineering College, Ludhiana
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-supercoders-campusdrive-activity-7445417260862664704-Vvv9?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/supercoders_drive_bce.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="SuperCoders Drive Conducted at BCE, Patna">
          SuperCoders Drive Conducted at BCE, Patna
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-mlncollege-campustocorporate-activity-7407028042570665984-jLz4?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/MLN_College_Team_Visits.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="MLN College Team Visits CodeQuotient">
          MLN College Team Visits CodeQuotient
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_christmascelebration-codequotient-teamculture-activity-7410309265631969280-saYz?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/Christmas_2026.jpg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Christmas Celebrations at CodeQuotient">
          Christmas Celebrations at CodeQuotient
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_ai-dataanalytics-handsonlearning-activity-7414529940722946049-pQ04?utm_source=share&amp;utm_medium=member_desktop&amp;rcm=ACoAAER7iqsBok0mVRcC38OU64P9cwTz5n0ywIA">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/workshop_at_kuk.jpeg" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Workshop on AI &amp; Data Analytics at KUK">
          Workshop on AI &amp; Data Analytics at KUK
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
  </div><div class="col-12 col-md-3 item">
    <a style="text-decoration: none;" target="_blank" href="https://www.linkedin.com/posts/codequotient_codequotient-placementdrive-jmitradaur-activity-7394698585059143680-a_ii?utm_source=li_share&amp;utm_content=feedcontent&amp;utm_medium=g_dt_web&amp;utm_campaign=copy">
      <div class="img__placeholder rounded" style="overflow: hidden;border: .2px #6a817d solid;text-align: center;">
        <img src="/images/news/JMIT_Placement_drive.png" alt="news image">
      </div>
      <div class="mt-3">
        <p class="news__title mb-1" title="Placement Drive Conducted at JMIT">
          Placement Drive Conducted at JMIT
        </p>
        <p class="news__source">www.linkedin.com</p>
      </div>
    </a>
    ...
    <a style="text-decoration: none;" target="_blank" href="https://www.aninews.in/news/business/business/codequotient-placed-over-150-supercoders-in-202120220221170035/">
      ...
      <div class="mt-3">
        ...
        <p class="news__source">www.aninews.in</p>
                        ...
                        <div class="MS-controls mt-5">
                            <button class="MS-right btn"><img src="/images/Polygon 60.svg" width="12px" alt="Launchpad of your Tech Career"></button>
                        </div>
                    </div>
                </section>
                <br>
      ...
      <div class="socials-details">
        <div class="brand-img">
          <a href="/" class="logo__link">
            <svg id="Component_10_6" data-name="Component 10 – 6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 792.463 115">
              <path id="Path_129" data-name="Path 129" d="M14.586-9.078q-10.3-10.4-10.3-27.234t10.3-27.234q10.3-10.4,26.112-10.4,12.852,0,22.236,6.783a31.115,31.115,0,0,1,12.24,18.411l-15.3,3.162a17.568,17.568,0,0,0-6.732-10.455A20.531,20.531,0,0,0,40.7-59.772q-9.792,0-15.249,6.324T19.992-36.312q0,10.812,5.457,17.136T40.7-12.852a20.531,20.531,0,0,0,12.444-3.723A17.568,17.568,0,0,0,59.874-27.03l15.3,3.162A31.115,31.115,0,0,1,62.934-5.457Q53.55,1.326,40.7,1.326,24.888,1.326,14.586-9.078ZM127.194-6.834q-7.752,8.058-20.3,8.058T86.6-6.885a27.631,27.631,0,0,1-7.752-19.839A27.631,27.631,0,0,1,86.6-46.563q7.752-8.109,20.3-8.109t20.3,8.109a27.631,27.631,0,0,1,7.752,19.839A27.807,27.807,0,0,1,127.194-6.834ZM97.1-37.842q-3.774,4.08-3.774,11.118t3.825,11.118a12.768,12.768,0,0,0,9.741,4.08,12.768,12.768,0,0,0,9.741-4.08q3.825-4.08,3.825-11.118t-3.825-11.118a12.768,12.768,0,0,0-9.741-4.08A12.93,12.93,0,0,0,97.1-37.842Zm81.7-9.894V-76.5H193.29V0H179.928V-6.528Q174.624,1.224,163,1.224q-11.322,0-17.952-7.956t-6.63-19.992q0-12.036,6.63-19.992T163-54.672a21.488,21.488,0,0,1,9.435,1.989A17.125,17.125,0,0,1,178.806-47.736ZM175.542-15.81a16.178,16.178,0,0,0,3.672-10.914,16.322,16.322,0,0,0-3.621-10.914,11.876,11.876,0,0,0-9.537-4.284,11.876,11.876,0,0,0-9.537,4.284A16.322,16.322,0,0,0,152.9-26.724a16.322,16.322,0,0,0,3.621,10.914,11.876,11.876,0,0,0,9.537,4.284A11.729,11.729,0,0,0,175.542-15.81Zm62.526-1.632,13.362,3.06A24.982,24.982,0,0,1,242.2-2.907q-6.171,4.131-15.147,4.131-11.832,0-19.38-7.854t-7.548-20.2q0-11.934,7.548-19.89t19.278-7.956q11.73,0,19.125,7.905t7.4,19.941l-.2,4.284h-38.76a12.813,12.813,0,0,0,4.08,8.415,13.1,13.1,0,0,0,8.874,2.907Q235.212-11.22,238.068-17.442Zm-11.22-25.6a11.965,11.965,0,0,0-8.058,2.7,12.539,12.539,0,0,0-4.08,7.395h24.276a12.232,12.232,0,0,0-3.978-7.344A11.974,11.974,0,0,0,226.848-43.044ZM295.494,1.53q-16.422,0-27.03-10.71T257.856-36.21q0-16.32,10.608-27.03t27.03-10.71q16.422,0,27.03,10.71t10.608,27.03a39.776,39.776,0,0,1-3.315,16.269,34.6,34.6,0,0,1-9.333,12.6l.816.918a21.737,21.737,0,0,0,6.069,5.61,13.1,13.1,0,0,0,6.375,1.53l2.04-.1V13.566q-1.632.1-2.142.1-13.566,0-22.542-10.914L308.448-.51A40.7,40.7,0,0,1,295.494,1.53Zm15.81-20.6q6.12-6.528,6.12-17.136T311.3-53.295q-6.12-6.477-15.81-6.477t-15.81,6.477q-6.12,6.477-6.12,17.085t6.12,17.085q6.12,6.477,15.81,6.477T311.3-19.074Zm66.3-3.978v-30.4h14.484V0H378.726V-6.528q-4.182,7.752-15.708,7.752-9.384,0-14.433-5.763t-5.049-15.555V-53.448H358.02v31.722q0,10.506,8.874,10.506,5.3,0,8.007-3.06T377.6-23.052ZM450.33-6.834q-7.752,8.058-20.3,8.058t-20.3-8.109a27.631,27.631,0,0,1-7.752-19.839,27.631,27.631,0,0,1,7.752-19.839q7.752-8.109,20.3-8.109t20.3,8.109a27.631,27.631,0,0,1,7.752,19.839A27.807,27.807,0,0,1,450.33-6.834ZM420.24-37.842q-3.774,4.08-3.774,11.118t3.825,11.118a12.768,12.768,0,0,0,9.741,4.08,12.768,12.768,0,0,0,9.741-4.08q3.825-4.08,3.825-11.118t-3.825-11.118a12.768,12.768,0,0,0-9.741-4.08A12.93,12.93,0,0,0,420.24-37.842Zm72.828,24.99V-.306a29.624,29.624,0,0,1-6.834.612q-16.422,0-16.422-16.32v-26.01H462.57V-53.448h7.242v-13.26H484.3v13.26h8.874v11.424H484.3v24.48q0,5.2,5.406,5.2Zm22.542-49.98a8.558,8.558,0,0,1-6.324,2.448,8.558,8.558,0,0,1-6.324-2.448,8.429,8.429,0,0,1-2.448-6.222,8.6,8.6,0,0,1,2.448-6.273,8.464,8.464,0,0,1,6.324-2.5,8.464,8.464,0,0,1,6.324,2.5,8.6,8.6,0,0,1,2.448,6.273A8.429,8.429,0,0,1,515.61-62.832ZM502.044,0V-53.448h14.484V0Zm62.322-17.442,13.362,3.06A24.982,24.982,0,0,1,568.5-2.907q-6.171,4.131-15.147,4.131-11.832,0-19.38-7.854t-7.548-20.2q0-11.934,7.548-19.89t19.278-7.956q11.73,0,19.125,7.905t7.395,19.941l-.2,4.284H540.8a12.813,12.813,0,0,0,4.08,8.415,13.1,13.1,0,0,0,8.874,2.907Q561.51-11.22,564.366-17.442Zm-11.22-25.6a11.965,11.965,0,0,0-8.058,2.7,12.539,12.539,0,0,0-4.08,7.395h24.276a12.232,12.232,0,0,0-3.978-7.344A11.974,11.974,0,0,0,553.146-43.044Zm49.776-10.4v6.528q4.182-7.752,15.912-7.752,9.486,0,14.586,5.763t5.1,15.555V0H624.036V-31.722q0-10.506-9.078-10.506-5.2,0-8.058,3.111T604.044-30.6V0H589.56V-53.448Zm73.44,40.6V-.306a29.624,29.624,0,0,1-6.834.612q-16.422,0-16.422-16.32v-26.01h-7.242V-53.448h7.242v-13.26H667.59v13.26h8.874v11.424H667.59v24.48q0,5.2,5.406,5.2Z" transform="translate(115.999 91.579)" fill="#fff"></path>
              <g id="Group_23" data-name="Group 23" transform="translate(-327 -258)">
                <g id="Component_8_37" data-name="Component 8 – 37" transform="translate(327 258)">
        ...
        <div class="social-icons mb-2">
          <a target="__blank" style="display: inline-block;" href="https://www.linkedin.com/company/codequotient/">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin" data-lov-id="src/components/Footer.tsx:157:16" data-lov-name="Linkedin" data-component-path="src/components/Footer.tsx" data-component-line="157" data-component-file="Footer.tsx" data-component-name="Linkedin" data-component-content="%7B%7D" style="color: rgb(209, 213, 219);">
              <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" style="color: rgb(209, 213, 219);"></path>
              <rect width="4" height="12" x="2" y="9"></rect>
              <circle cx="4" cy="4" r="2"></circle>
            </svg>
          </a>

          <a target="__blank" style="display: inline-block; width: 25px;height: 25px;" href="https://twitter.com/CodeQuotient" aria-label="Twitter">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 128 128" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(209, 213, 219);">
              <g style="transform: scale(0.5)" transform-origin="center">
                <path d="M75.916 54.2 122.542 0h-11.05L71.008 47.06 38.672 0H1.376l48.898 71.164L1.376 128h11.05L55.18 78.303 89.328 128h37.296L75.913 54.2ZM60.782 71.79l-4.955-7.086-39.42-56.386h16.972L65.19 53.824l4.954 7.086 41.353 59.15h-16.97L60.782 71.793Z" fill="#fff"></path>
              </g>
            </svg>
          </a>

          <a target="__blank" style="display: inline-block; width: 25px;height: 25px; " href="https://github.com/codequotient" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(209, 213, 219);">
          ...
          <a target="__blank" style="display: inline-block; width: 25px;height: 25px; " href="https://www.youtube.com/@CodeQuotient" aria-label="Youtube">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-youtube" data-lov-id="src/components/Footer.tsx:133:16" data-lov-name="Youtube" data-component-path="src/components/Footer.tsx" data-component-line="133" data-component-file="Footer.tsx" data-component-name="Youtube" data-component-content="%7B%7D" style="color: rgb(209, 213, 219);">
              <path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17" style="color: rgb(209, 213, 219);"></path>
        ...
        <div>
          ...
          <a href="mailto:info@codequotient.com" class="email-link link" style="margin-top: 0; font-weight: 700;">info@codequotient.com</a>
        </div>
